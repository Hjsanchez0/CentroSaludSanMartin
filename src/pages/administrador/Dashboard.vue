        ...
        <div class="container">
            ...
            <div class="profile-container">
                <div class="profile">
                    ...
                    <hr class="linea">
                    <button class="cita" @click="toggleSpecialistInfo"><img src="../../assets/especialista.png"
                            alt="Appointment Icon" class="button-icon">Especialistas</button>
                    <hr class="linea">
                ...
                <div class="button-container">
                    <div v-if="showSpecialistInfo" class="button-box">
                        <ListSpecialist :userData="userData" />
                    </div>
...
import ListSpecialist from '../../components/administrador/ListSpecialist.vue';
import ListPacientes from '../../components/administrador/ListPacientes.vue';
...
export default {
    ...
    methods: {
        ...
        toggleSpecialistInfo() {
            this.showSpecialistInfo = !this.showSpecialistInfo;
            this.showPacientesInfo = false;
        },

        togglePacientesInfo() {
            this.showPacientesInfo = !this.showPacientesInfo;
            this.showSpecialistInfo = false;
        }
    }
};
</script>
